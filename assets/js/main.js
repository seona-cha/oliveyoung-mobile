    ...
    .then(json =>{
        ...
        html+=`
            <li class="swiper-slide link-more2">
                ...
                <svg viewBox="0 0 32 32" class=""><path d="m17.822 5 11.51 11.336-11.51 11.337-1.404-1.425 9.05-8.915H2.668v-2h22.796l-9.045-8.908L17.822 5z"></path></svg>
                더보기
                </button>
            </li>
        `
        ...
        const recommScroll = new Swiper(".sc-recomm .swiper",{
            slidesPerView:"auto",
            freeMode: true,
            spaceBetween: 10
        })
    ...
    .then(json=>{
        ...
        fetch('./assets/data/product.json')
            ...
            .then(json=>{
                    ...
                    <li class="prd-item ranking">
                        ...
                        <div class="text-box">
                            <div class="info-wrap">
                                ...
                                `
                                if(element.best){
                                    html2+=`<span class="best">BEST</span>`
                                }
                                html2+=`
                                ${element.productName}
                                </strong>
                ...
                $(`.sc-cate-ranking .prd-list`).html(html2)
        
        
            //카테고리 랭킹 슬라이더
            const cateRankingTab = new Swiper(".sc-cate-ranking .swiper-tab",{
                slidesPerView:"auto",
                freeMode: true,
                spaceBetween: 8
            })
            const cateRankingSlider = new Swiper(".sc-cate-ranking .swiper",{
                loop:true,
                navigation:{
...
.then(json=>{
    ...
    const dessertSlider = new Swiper(".sc-dessert .swiper",{
        pagination:{
                ...
                <div class="brand-area">
                    <a href="${element.linkUrl}">
                        ...
                        <div class="info-box">
                            <h3>${element.name}</h3>
                            <p>
                                <svg viewBox="0 0 32 32" class="Icon_size-12__fnguE">
